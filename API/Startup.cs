...
namespace ProjectAPI.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Registrar CustomerService como un servicio scoped
            services.AddScoped<CustomerService>();

            // Registrar BaseModel<TEntity> como servicio scoped
            services.AddScoped(typeof(BaseModel<>));

            // Registrar BaseService<TEntity> como servicio scoped
